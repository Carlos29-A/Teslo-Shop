...
import { Category, ICategory, Product } from "@/interfaces";
    ...
    <form className="grid px-5 mb-16 grid-cols-1 sm:px-0 sm:grid-cols-2 gap-3">
      ...
      <div className="w-full">
        <div className="flex flex-col mb-2">
          <span>Título</span>
          <input type="text" className="p-2 border border-gray-300 rounded-md bg-gray-200" />
        </div>
        ...
        <div className="flex flex-col mb-2">
          <span>Gender</span>
          <select className="p-2 border border-gray-300 rounded-md bg-gray-200">
